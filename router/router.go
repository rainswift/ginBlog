...
func Start() {
	...
	editRouter := e.Group("/edit")
	editRouter.POST("/save", ParseToken(), api.EditSave)
	editRouter.GET("/list", ParseToken(), api.GetEditList)
	editRouter.GET("/deatils", ParseToken(), api.GetDeatils)
	editRouter.POST("/delect", ParseToken(), api.EditDelect)
